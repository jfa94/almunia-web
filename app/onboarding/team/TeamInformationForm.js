...
import {submitTeamInformationForm} from "@/app/onboarding/team/submitTeamInformationForm";
        ...
        <div className={`${hidden && 'hidden'}`}>
            ...
            <form action={submitTeamInformationForm}>
                ...
                <div className="flex flex-col md:flex-row gap-4 md:justify-end mt-4">
                    <button onClick={addInputToArray} className="btn btn-neutral btn-sm md:btn-md min-w-36">
                        Add
