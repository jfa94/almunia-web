...
export async function getCompanyInformation() {
    ...
    try {
        ...
        // TODO: Standardise action responses to use something like {ok: true, data: ...}
        return {identity_id: identityId, ...getResponse.Item}
    } catch (error) {
        // TODO: Standardise error handling in actions to use something like {ok: false, error: error}
        return error
    }
}
